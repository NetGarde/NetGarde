...
const edges: NetworkMapEdge[] = [
  { source: 'app:chrome', target: EC2_GATEWAY_NODE_ID, kind: 'path_egress', query_count: 2, blocked_count: 0 },
  { source: EC2_GATEWAY_NODE_ID, target: DNS_GATEWAY_NODE_ID, kind: 'path_tunnel', query_count: 2, blocked_count: 0 },
...
describe('computeTunnelWhatIfSimulation', () => {
  it('cuts EC2 gateway and flow_via_gateway edges when tunnel is blocked', () => {
