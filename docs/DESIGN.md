...
2. **EDR-lite endpoint detection** — TrustEdge Agent events feed Kafka-backed detection (YAML attack/chain rules, behavior baselines, novel-process alerts, and AI activity sessions).
